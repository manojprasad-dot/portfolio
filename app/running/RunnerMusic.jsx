        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 gap-y-10">
          {RUNNING_PLAYLISTS.map((playlist, idx) => (
              ...
              >
                ...
                <div className="relative h-full bg-white/[0.02] backdrop-blur-3xl border border-white/5 rounded-[2rem] p-4 flex flex-col overflow-hidden transition-all duration-300 hover:border-orange-500/30">
