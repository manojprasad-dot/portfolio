...
function RunningPage() {
                ...
                "RunningPage.useEffect": (data)=>{
                    ...
                    if (Array.isArray(data)) {
                        const dist = data.reduce({
                            "RunningPage.useEffect.dist": (acc, run)=>acc + run.distance
                        }["RunningPage.useEffect.dist"], 0);
                        const elev = data.reduce({
                            "RunningPage.useEffect.elev": (acc, run)=>acc + run.total_elevation_gain
                        }["RunningPage.useEffect.elev"], 0);
                        const time = data.reduce({
                            "RunningPage.useEffect.time": (acc, run)=>acc + run.moving_time
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            Array.isArray(runs) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(RunningPage, "UWQsKIz4MoePmPP5g9W96VtqJy0=");
_c1 = RunningPage;
var _c, _c1;
